...
## 畫面資訊 ##
學習版上有 OLED 單色螢幕的擴充插槽，可顯示攝氏溫度與電池電壓，以及當前的日期時間，當事件觸發，狀態會立即顯示，無觸發時，每秒會更新一次畫面，可當作電子時鐘應用，每分鐘會對溫度與電壓發送異常偵測通知，當溫度超過40度為異常，或16850電池電壓低於3.6，太陽能電池電壓低於10.8時，會發出LINE通知。<br>
